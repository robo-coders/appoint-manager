{{--
    ARCHIVE — the live marketing homepage before the editorial direction
    shipped. Kept so the refill-sum / "who pays" framing can be reused
    (the comparison now lives on /pricing). Not rendered.

    Was: resources/views/marketing/home.blade.php
--}}
...
{{--
    ...
    **What changed from direction A, and why.** The approved direction led with a
    ledger comparing a competitor's per-booking fee against our £29. That
    ...
    at eighty, it rests on our own £29 rather than on somebody else's fee, and no
