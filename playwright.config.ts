...
export default defineConfig({
    ...
    projects: [
        ...
        { name: 'console-setup', testMatch: /console\.setup\.ts/ },
        {
            name: 'operator',
            dependencies: ['setup'],
            testMatch: /(screens|mobile|manage-booking|logout|alerts|loyalty-settings|theme)\.spec\.ts/,
        ...
        },
        {
            ...
            testMatch: /(slot-race|auth|register|errors|marketing|booking-states)\.spec\.ts/,
