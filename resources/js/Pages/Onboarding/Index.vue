...
<template>
    <SetupChrome :steps="steps" :current="step">
        ...
        <section v-if="step === 'basics'">
            <h1 class="display-light text-34 tracking-34">Tell us about the business</h1>
            <p class="mt-2 max-w-auth-col text-14 text-ink-2">
                This sets your booking page name and the default working week. You can change both later in
                Settings.
            </p>

            <div class="mt-12 max-w-auth-col">
                <TextInput
                    v-model="form.name"
                    label="Business name"
                    :error="errors.name"
        ...
        <section v-else-if="step === 'business'">
            <h1 class="display-light text-34 tracking-34">Where and when you trade</h1>
            <p class="mt-2 max-w-auth-col text-14 text-ink-2">
                The timezone decides what time a booking is in. The rest appears on confirmations and on your
                booking page.
            </p>

            <div class="mt-12 max-w-auth-col space-y-4">
                <Select
        ...
        <section v-else-if="step === 'services'">
            <h1 class="display-light text-34 tracking-34">Add your first service</h1>
            <p class="mt-2 max-w-auth-col text-14 text-ink-2">
            ...
            <div class="mt-12 grid gap-12 lg:grid-cols-[minmax(0,1fr)_18rem]">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        />
                        <p class="mt-2 max-w-auth-col text-12 text-ink-2">
        ...
        <section v-else-if="step === 'link'">
            ...
            <h1 class="display-light mt-3 text-34 tracking-34">Share your booking link</h1>
            <p class="mt-2 max-w-auth-col text-14 text-ink-2">
            ...
            <div class="mt-12 flex flex-wrap items-start gap-12">
                <div class="min-w-64 flex-1">
                    ...
                    <p class="mt-3 max-w-auth-col text-13 text-ink-2">
